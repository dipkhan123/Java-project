...
public class Buy extends JFrame implements iBuy{
	private Container c;
	private JPanel jp1;
	...
	public Buy()
	{
		...
		c.setBackground(c1);
		txt1=new JLabel("Available for Sale");
		...
		try {
        imglabel1.setIcon(new ImageIcon("Image/flat3.jpg"));
        imglabel2.setIcon(new ImageIcon("Image/flat1.jpg"));
        imglabel3.setIcon(new ImageIcon("Image/flat2.jpg"));
        } 
		catch (Exception e) {
		...
		c.add(imglabel3);
		txt2=new JLabel("ANWAR Landmark");
	...
	{
		dispose();
		BuyProperty3 obj=new BuyProperty3();
		obj.setVisible(true);
	}
}