...
public class BuyProperty1 extends JFrame{
	private Container c;
	...
	void initcomponents()
	{
		...
		txt6.setFont(f2);
		c.add(txt6);
		txt7=new JLabel("plot 7,road 2, Gulshan");
		txt7.setBounds(190,70,180,30);
		txt7.setFont(f3);
		txt7.setForeground(Color.WHITE);
		c.add(txt7);
		txt8=new JLabel("3440 sqft");
		txt8.setBounds(190,110,180,30);
		txt8.setFont(f3);
		txt8.setForeground(Color.WHITE);
		c.add(txt8);
		txt9=new JLabel("19.74 katha");
		...
		c.add(txt11);
		txt13=new JLabel("Price");
		txt13.setBounds(20,260,180,30);
		txt13.setForeground(Color.WHITE);
		txt13.setFont(f2);
		c.add(txt13);
		txt14=new JLabel("90 lakhs");
		...
		c.add(txt12);
		label1=new JLabel();
		label1.setIcon(new ImageIcon("Image/buy1.jpg"));
		label1.setBounds(25,312,250,250);
		c.add(label1);
		label2=new JLabel();
		label2.setIcon(new ImageIcon("Image/buy2.jpg"));
		label2.setBounds(275,340,250,195);
		c.add(label2);
		label3=new JLabel();
		label3.setIcon(new ImageIcon("Image/buy4.jpg"));
		label3.setBounds(525,340,250,195);
		c.add(label3);
		btn2=new JButton();
		...
		btn3.addActionListener(new ActionListener(){
			...
			{
				dispose();
				BuyPay obj=new BuyPay();
				obj.setVisible(true);
			}
		});
		c.add(btn3);
		btn4=new JButton("EMI calculator");
		btn4.setBounds(680,160,120,30);
		btn4.setBackground(new Color(34,167,240));
