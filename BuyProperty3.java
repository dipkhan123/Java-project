...
public class BuyProperty3 extends JFrame{
	private Container c;
	...
	void initcomponents()
	{
		...
		txt6.setFont(f2);
		c.add(txt6);
		txt7=new JLabel("plot 19/21,road 10, Badda");
