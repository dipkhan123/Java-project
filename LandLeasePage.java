...
import java.awt.event.*;
    ...
    public class LandLeasePage extends JFrame {
    private Container c;
    ...
    void initcomponents()
	{
        ...
        addressLabel = new JLabel("Address: Plot 7, Road 2, Gulshan");
        addressLabel.setBounds(20, 80, 400, 30);
        addressLabel.setFont(labelFont);
        addressLabel.setForeground(Color.WHITE);
        c.add(addressLabel);

        sizeLabel = new JLabel("Size: 5000 sqft");
        ...
        rentLabel = new JLabel("Rent Amount: 35,000 per month");
		...
		pic=new JLabel();
		pic.setIcon(new ImageIcon("Image/land1.jpg"));
