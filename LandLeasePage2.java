...
import java.awt.event.*;
    ...
    public class LandLeasePage2 extends JFrame {
    private Container c;
    ...
    void initcomponents()
	{
        ...
        backButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                dispose();
				LandLeasePage1 obj=new LandLeasePage1();
				obj.setVisible(true);
            }
        });
        c.add(backButton);
        ...
        addressLabel = new JLabel("Address: Plot 5, Road 2, Dhanmondi");
        addressLabel.setBounds(20, 80, 400, 30);
        addressLabel.setFont(labelFont);
        addressLabel.setForeground(Color.WHITE);
        c.add(addressLabel);

        sizeLabel = new JLabel("Size: 2000 sqft");
        sizeLabel.setBounds(20, 120, 400, 30);
        sizeLabel.setFont(labelFont);
        sizeLabel.setForeground(Color.WHITE);
        c.add(sizeLabel);

        durationLabel = new JLabel("Lease Duration: 5 years");
        durationLabel.setBounds(20, 160, 400, 30);
        durationLabel.setFont(labelFont);
        durationLabel.setForeground(Color.WHITE);
        c.add(durationLabel);

        rentLabel = new JLabel("Rent Amount: 30,000 per month");
		...
		pic=new JLabel();
		pic.setIcon(new ImageIcon("Image/land3.jpg"));
