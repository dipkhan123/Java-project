...
public class RentProperty1 extends JFrame{
	private Container c;
	...
	private Cursor csr;
	public RentProperty1()
	{
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setSize(830,600);
		setLocationRelativeTo(null);
		setTitle("Property1/rent");
		setResizable(false);
		initcomponents();
	}
	void initcomponents()
	{
		...
		txt13.setFont(f2);
		c.add(txt13);
		txt14=new JLabel("50K");
		txt14.setBounds(190,260,200,30);
