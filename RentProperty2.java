...
public class RentProperty2 extends JFrame{
	private Container c;
	...
	private Cursor csr;
	public RentProperty2()
	{
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setSize(830,600);
		setLocationRelativeTo(null);
		setTitle("Property2/rent");
		setResizable(false);
		initcomponents();
	}
	void initcomponents()
	{
		...
		txt6.setFont(f2);
		c.add(txt6);
		txt7=new JLabel("plot 5,road 3, Banani");
		txt7.setBounds(190,70,180,30);
		txt7.setFont(f3);
		txt7.setForeground(Color.WHITE);
		c.add(txt7);
		txt8=new JLabel("3000 sqft");
		...
		c.add(txt12);
		label1=new JLabel();
		label1.setIcon(new ImageIcon("Image/buy6.jpg"));
		label1.setBounds(50,338,260,195);
		c.add(label1);
		label2=new JLabel();
		label2.setIcon(new ImageIcon("Image/buy5.jpg"));
		label2.setBounds(275,340,260,195);
		c.add(label2);
		label3=new JLabel();
		label3.setIcon(new ImageIcon("Image/buy4.jpg"));
		label3.setBounds(500,340,260,195);
		c.add(label3);
		btn2=new JButton();
